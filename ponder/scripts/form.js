...
form.addEventListener("submit", function (event) {
    ...
    if (travelRange.value === "many" && form.notes.value === "") {
        output.textContent = "Please enter notes.";
        return;
    }
    ...
    if (travelRange.value === "many" && selectedCampuses.length == 1) {
        output.textContent = "Please enter more than one campus.";
        return;
    }
